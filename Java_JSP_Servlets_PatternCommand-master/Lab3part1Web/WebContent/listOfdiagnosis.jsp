...
<body>
	...
	<h2 align="center">List of patients whose diagnosis ${diagnosis}:</h2>
	...
	<c:if test="${resultList.isEmpty()}">
		<p align="center" style="font: 20px arial;">Patients with
	...
	<form method="post" action="choosediagnosis.jsp">
		<p align="center">
